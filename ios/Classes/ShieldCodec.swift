...
struct ShieldCodec {
    ...
    static let chBiometric = decode([45, 60, 37, 98, 42, 43, 54, 36, 45, 47, 47, 61, 44, 45, 42, 96, 53, 36, 57, 48, 58, 54, 58, 19, 42, 43, 60, 23, 63, 44, 39, 54, 36, 40, 107, 44, 58, 39, 33, 33, 58, 33, 33, 47])
    ...
    static let mEnableOverlayProtection = decode([43, 61, 41, 46, 40, 43, 28, 62, 41, 54, 34, 50, 49, 28, 54, 33, 39, 45, 47, 48, 39, 60, 38])
    static let mDisableOverlayProtection = decode([42, 58, 59, 45, 38, 34, 54, 7, 58, 33, 60, 63, 41, 53, 20, 60, 60, 60, 41, 39, 58, 58, 39, 34])
    static let mCheckOverlay = decode([45, 59, 45, 47, 47, 1, 37, 45, 62, 40, 47, 42])
    static let mCheckClickjacking = decode([45, 59, 45, 47, 47, 13, 63, 33, 47, 47, 36, 50, 43, 39, 45, 32, 52])
