...
class SecureStorageHandler {
    ...
    func write(key: String, value: String) -> Bool {
        ...
        return SecItemAdd([kSecClass as String: kSecClassGenericPassword, kSecAttrService as String: svc, kSecAttrAccount as String: key, kSecValueData as String: data] as CFDictionary, nil) == errSecSuccess
    }
